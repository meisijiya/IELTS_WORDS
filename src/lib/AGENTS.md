...
- `/home/ljh2923/opencode-project/English_YASI/src/lib/word-collections.ts`: Pure 3-way partition of words into `wrong` / `learning` / `mastered` buckets. Also exports `aggregateWordsByWord`, `sortByAttempts`, `sortByMasteredAt` for the three collection pages.
