...
- Cache-bust note: each chapter and `index.html` reference `?v=3` to defeat the Cloudflare cache that sits in front of `<host>` (Cloudflare `cache-control: max-age=14400`).
